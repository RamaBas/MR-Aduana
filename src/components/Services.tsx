...
import { Globe, Truck, FileText, DollarSign, ClipboardCheck, Layers, BarChart } from 'lucide-react';
import ScrollAnimation from './ScrollAnimation';

const services = [
    { 
      icon: ClipboardCheck, 
      title: "Recuperación de Envíos Retenidos", 
    ...
    { 
      icon: BarChart, 
      title: "Análisis de Mercados Internacionales", 
      desc: "Realizamos un análisis detallado de mercados internacionales, identificando oportunidades comerciales, tendencias relevantes y normativas específicas. Proveemos información estratégica para optimizar decisiones de importación y exportación." 
    },
    { 
      icon: DollarSign, 
  ...
  return (
    <section id="services" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <ScrollAnimation>
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 title-underline">Nuestros Servicios</h2>
        </ScrollAnimation>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <ScrollAnimation key={index}>
            <div className="bg-background-light p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300 transform hover:-translate-y-1 flex flex-col items-center justify-between min-h-[300px]">
